- [1.6 高阶函数](#16-高阶函数)
  - [1.6.1 作为参数的函数](#161-作为参数的函数)
  - [1.6.2 作为一般方法的函数](#162-作为一般方法的函数)
  - [1.6.3 定义函数 III：嵌套定义](#163-定义函数-iii嵌套定义)
  - [1.6.4 作为返回值的函数](#164-作为返回值的函数)
  - [1.6.5 Lambda 表达式](#165-lambda-表达式)
  - [1.6.6 示例：牛顿法](#166-示例牛顿法)
  - [1.6.7 抽象和一等函数](#167-抽象和一等函数)
  - [1.6.8 函数装饰器](#168-函数装饰器)
